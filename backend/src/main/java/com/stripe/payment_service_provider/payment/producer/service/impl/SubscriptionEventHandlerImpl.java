...
import com.stripe.payment_service_provider.payment.producer.service.StripeSubscriptionEventHandler;
...
public class SubscriptionEventHandlerImpl implements StripeSubscriptionEventHandler {
    ...
    @Transactional
    public void handleSubscriptionCreate(Subscription subscription) {
    ...
    @Transactional
    public UserSubscription handleSubscriptionCancel(Subscription subscription) {
