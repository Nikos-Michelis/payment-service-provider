...
public class SubscriptionEventHandlerImpl implements StripeSubscriptionEventHandler {
    ...
    public void handleSubscriptionChange(Subscription subscription) throws StripeException {
        ...
        StripeSubscriptionDTO stripeSubscriptionDTO = StripeSubscriptionDTO.builder()
                ...
                .currentPeriodStart(Instant.ofEpochSecond(subscription.getItems().getData().getFirst().getCurrentPeriodStart()))
    ...
    public UserSubscription handleSubscriptionCancellation(Subscription subscription) {
        ...
        return subscriptionService.createOrUpdate(user.getStripeCustomer(), stripeSubscriptionDTO, stripePlan);
    }
}
