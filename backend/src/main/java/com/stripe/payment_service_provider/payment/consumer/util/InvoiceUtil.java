package com.stripe.payment_service_provider.payment.consumer.util;
...
public class InvoiceUtil {
    ...
    public PaymentIntent getPaymentIntentObjectFromInvoice(Invoice invoice) {
        return invoice.getPayments().getData().getFirst().getPayment().getPaymentIntentObject();
    }
